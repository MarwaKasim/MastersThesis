...
# -*- coding: utf-8 -*-
"""
Created on Wed May 29 02:21:32 2024
...
#load the dataset
df = pd.read_csv('Modulbeskrivelser_keywords.csv')
...
def get_top_words_and_scores(row, top_n=10):
...
#save the df to CSV
top_words_scores_df.to_csv('Top_Words_Scores_Per_Topic_modul.csv', index=True)
